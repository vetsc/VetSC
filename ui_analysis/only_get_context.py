...
def get_all_context_of_page(driver: webdriver):
    ...
    print("the followings are the buttons name")
    for button in buttons:
        try:
            print('[' + button.text + ']', end=' ')
        except:
            continue
    print("\nthe followings are the semantics marked by me\n")
    print("the followings are the context")
...
def main():
    # website = "https://cryptofollowers.net/marketplace/#!/token/114"
