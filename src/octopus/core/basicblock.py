...
class BasicBlock(object):
    ...
    def __init__(self, start_offset=0x00, start_instr=None,
        ...
        # Yue: store the name of the basic blocks that have control flow with 'self'
        self.next_bbs = list()
        self.prev_bbs = list()
        self.conditional_bb = None

    def addNextBBs(self, bb, edge):
        self.next_bbs.append(bb)
        if edge == EDGE_CONDITIONAL_TRUE:
            self.conditional_bb = bb

    def addPrevBBs(self, bb):
        self.prev_bbs.append(bb)
